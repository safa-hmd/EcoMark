...
class PhotoIAController extends AbstractController
{
    ...
    #[Route('/dashboard', name: 'vendeur_photo_test')]
    public function dashboard(): Response
    {
        $this->denyAccessUnlessGranted('ROLE_VENDEUR');
        
        return $this->render('Vendeur/GestionUser/dashboard.html.twig', [
            'vendeur' => $this->getUser()
        ]);
    }

    #[Route('/upload', name: 'vendeur_photo_upload', methods: ['POST'])]
    public function upload(Request $request): JsonResponse
    {
        try {
            ...
            // Sauvegarder
            $filename = uniqid('vendeur_') . '.' . $file->guessExtension();
            $projectDir = $this->getParameter('kernel.project_dir');
    ...
    #[Route('/analyze', name: 'vendeur_photo_analyze', methods: ['GET'])]
    ...
    #[Route('/generate-from-description', name: 'vendeur_photo_generate_from_description', methods: ['POST'])]
    ...
    #[Route('/save-generated', name: 'vendeur_photo_save_generated', methods: ['POST'])]
    public function saveGenerated(Request $request): JsonResponse
    {
        try {
            ...
            // Sauvegarder
            $filename = uniqid('vendeur_ai_') . '.jpg';
    ...
    #[Route('/enhance-recreate', name: 'vendeur_photo_enhance_recreate', methods: ['POST'])]
    ...
    #[Route('/generate-variants', name: 'vendeur_photo_generate_variants', methods: ['POST'])]
