...
class PhotoIAController extends AbstractController
{
    ...
    public function dashboard(): Response
    {
        ...
        return $this->render('Admin/GestionUser/dashboard.html.twig', [
            'admin' => $this->getUser()
        ]);
    }
    ...
    public function upload(Request $request): JsonResponse
    {
        try {
            ...
            // Sauvegarder
            $filename = uniqid('admin_') . '.' . $file->guessExtension();
            $projectDir = $this->getParameter('kernel.project_dir');
    ...
    #[Route('/save-generated', name: 'admin_photo_save_generated', methods: ['POST'])]
    ...
    #[Route('/enhance-recreate', name: 'admin_photo_enhance_recreate', methods: ['POST'])]
    ...
    #[Route('/generate-variants', name: 'admin_photo_generate_variants', methods: ['POST'])]
